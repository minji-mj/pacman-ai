...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    pqueue = util.PriorityQueue()               # using priority queue
        ...
        if problem.isGoalState(node):
            ...
            if node not in explored:
                ...
                for successor in successors:
                    ...
                    pqueue.push((childNode, fullPath, fullCost), fullCost + heuristic(childNode, problem))
    return path
